...
class TSFDQN_PHI(Agent):
    ...
    def train_agent(self, s, s_enc, a, r, s1, s1_enc, gamma):
        ...
        if self.total_training_steps % 10 == 0:
            ...
            for index in range(self.n_tasks):
                self.update_deep_models(transitions, self.phis, index)
    ...
    def update_deep_models(self, transitions, phis_models, policy_index):
        ...
        phi_model_tuple, _ = phis_models[policy_index]
